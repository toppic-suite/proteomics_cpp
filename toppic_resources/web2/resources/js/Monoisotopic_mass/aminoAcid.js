this.AminoAcid =  function(aaCode, aaShortName, aaName, monoMass, avgMass){
	this.code = aaCode;
	this.shortName = aaShortName;
	this.name = aaName;
	this.mono = monoMass;
	this.avg = avgMass;
	this.getAcidMass = getAcidMass ;
}
...
AminoAcid.getAcidMass = getAcidMass ;
	
function getAcidMass(acid){
	return AminoAcid.aa[acid];
}

console.log("Acid mass : ",AminoAcid.getAcidMass("A"));
