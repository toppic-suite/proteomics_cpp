				...
				<div class="container-fluid">
					...
					<div>
						<ul class="nav navbar-nav">
							<li><a href="index.jsp"><strong>TopPIC</strong></a></li>
							<li class="active"><a href="results.jsp"><strong>Results</strong></a></li>
						</ul>
					</div>
				</div>
			</div>
						...
						<tr>
							...
							<th>
								<button type='button' class='btn btn-success btn-xs'
									onclick="window.location.reload()">Refresh All</button>
							</th>
						</tr>
					</thead>
					</tbody>
